...
*              - const uint8_t *c: pointer to PQCLEAN_MLDSA44_CLEAN_challenge hash length SEEDBYTES
...
*
* Arguments:   - uint8_t *c: pointer to output PQCLEAN_MLDSA44_CLEAN_challenge hash
